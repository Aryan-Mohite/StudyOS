  ...
  "inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        outline:  "border border-border bg-transparent text-ink hover:bg-brand-50 dark:hover:bg-brand-500/10 hover:border-brand-200 dark:border-brand-500/30",
        ghost:    "text-ink-2 hover:bg-brand-50 dark:hover:bg-brand-500/10 hover:text-brand-600",
